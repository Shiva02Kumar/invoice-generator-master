        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="col-sm-10 col-sm-offset-1 text-center">
              ...
              <div className="contant_box_404" style={contantBox404Style}>
                <h3 className="h2" style={h3Style}>
                  Look like you're lost
                </h3>

                <p>the page you are looking for is not available!</p>

                <a href="/" className="link_404" style={link404Style}>
                  Go to Home
                </a>
              </div>
            </div>
